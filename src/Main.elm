                        ...
                        [ ul []
                            [ li [ class "admin-li" ]
                                ...
                                , ul [ class "navexpand", id "adminMenu" ]
                                    [ li []
                                        [ a [ href "/Admin/ManagePolls" ]
                                            [ text "Manage Polls" ]
                                        ]
                                    , li []
                                        [ a [ href "/Admin/ManageTopics" ]
                                            [ text "Manage Topics" ]
                                        ]
                                    , li []
                                        [ a [ href "/Admin/ManageSpaces" ]
                                            [ text "Manage Spaces" ]
                                        ]
                                    , li []
                                    ...
                                    , li []
                                        [ a [ href "/Admin/ManageThoughtRelevancy" ]
                                            [ text "Thought Relevancy" ]
                                        ]
                                    , li []
                                        [ a [ href "/TrialRequest/Manage" ]
                                            [ text "Manage Trial Requests" ]
                                        ]
                                    , li []
                                        [ a [ href "/Admin/SetLoggingLevel" ]
                                            [ text "Logging" ]
                                        ]
                                    ]
                                ]
                            , li [ class "user-li" ]
                                ...
                                , ul [ class "navexpand", id "userMenu" ]
                                    [ li []
                                        [ a [ href "/Topic/Thoughts" ]
                                            [ text "My Thoughts" ]
                                        ]
                                    , li []
                                        [ a [ href "/Topic/Favorites" ]
                                            [ text "My Favorites" ]
                                        ]
                                    , li []
                                    ...
                                    , li []
                                        [ a [ class "icon-logout pad logout", href "/Login/Logout" ]
                                            [ text "Log Out" ]
                                        ]
                                    ]
                                ]
...
subNav =
    div [ class "pure-g", id "subnav-wrapper" ]
        [ nav [ class "pure-u-1 clearfix" ]
            [ a [ class "icon-list pad back-btn", href "/Space/Index/3072", title "back to space" ]
                [ text "Sandbox Space for Chidi Anagonye"
                ]
            ]
        , div [ class "clear" ] []
        ]
        ...
        [ div [ class "wrapper pure-g-r" ]
            [ div [ class "pure-u-1-3", id "topic" ]
                [ div [ class "col-header" ]
                    ...
                    , nav [ class "drop-sauce" ]
                        [ ul []
                            [ li []
                                ...
                                , ul []
                                    [ li []
                                        [ a [ class "icon-pencil pad", href "/Admin/AddEditTopic/20688" ]
                                            [ text "Edit Topic" ]
                                        ]
                                    , li []
                                        [ a [ class "icon-statistics pad", href "/Admin/AddEditPoll/0?topicid=20688" ]
                                            [ text "Edit                                            Polls" ]
                                        ]
                                    , li []
                                        [ a [ class "icon-user pad", href "/Admin/ToggleAnonymous" ]
                                            [ text "Turn Anonymous Off" ]
                                        ]
                                    , li []
                                        [ a [ class "icon-eye-blocked pad", href "/Topic/ViewHidden/20688" ]
                                            [ text "Hidden Thoughts" ]
                                        ]
                                    , li []
                                        [ a [ class "icon-comment pad", href "/Admin/ToggleWordCloud?topicId=20688" ]
                                            [ text "Enable                                            Word Cloud" ]
                                        ]
                                    , li [ class "break" ]
                                        []
                                    , li [ class "small" ]
                                        [ a [ class "icon-lock pad", href "/Topic/ToggleLocked/20688", id "lock-btn", title "Lock Topic" ]
                                            [ text "Lock Topic" ]
                                        ]
                                    ]
                                ]
                    ...
                    , a [ class "picView col-header-btn icon-image tipsy-n", href "/Topic/Images/20688", id "picView-btn", title "Pic View" ]
                        [ span [ class "screenreader-only" ]
                            [ text "picture review" ]
                        ]
                    ]
                , div [ class "col-content" ]
                    [ a [ class "fav-topic icon-star fav-btn icon-btn tipsy-s ", href "/Topic/ToggleFavorite/20688?showReplies=0", title "Favorite Topic" ]
                        [ span [ class "screenreader-only" ]
                    ...
                    , h2 []
                        [ span [ class "icon-lock  tipsy-s", attribute "style" "display:none;", title "An instructor has locked this topic." ]
                            []
                        , text "Getting Started with Topics                    "
                        ]
                    , h3 [ class "overflow" ]
                    ...
                    , form [ action "/Topic/SubmitThought", class "", enctype "multipart/form-data", id "SubmitThought", method "post" ]
                        ...
                        , input [ id "PostTopicID", name "PostTopicID", type_ "hidden", value "20688" ]
                            []
                        , input [ attribute "data-val" "true", attribute "data-val-number" "The field TopicPostMaxLength must be a number.", attribute "data-val-required" "The TopicPostMaxLength field is required.", id "TopicPostMaxLength", name "TopicPostMaxLength", type_ "hidden", value "300" ]
                            []
                        , div [ class "topicthought" ]
                            [ textarea [ attribute "aria-label" "input what do you think here.", attribute "cols" "40", id "PostDescription", name "PostDescription", placeholder "What do you think?", attribute "rows" "2", attribute "satyle" "width:100%; margin-right:10px;" ]
                                []
                            , div [ class "clear" ]
                                []
                    ...
                    , div [ class "clear" ] []
                    , div []
                        [ input [ class "topic-submit", id "btnSubmit", type_ "submit", value "Submit" ] []
                        , text "                            "
                        ]
                    ]
                , div [ id "socialbox" ]
            ...
            , div [ class "pure-u-2-3", id "thoughts" ]
                ...
                , form [ action "/Topic/View/20688", attribute "category" "recent", class "submitReply", id "3072", method "post" ]
                    [ div [ class "col-header" ]
                        ...
                        , a [ class "col-header-btn", href "/Topic/View/20688", id "refreshThoughts" ]
                            [ text "Refresh Page" ]
                        ]
                    , ul [ class "pure-g", id "thought-tabs" ]
                        [ li [ class "current  pure-u-1-3", id "tabrecent" ]
                            [ a [ href "/Topic/View/20688?category=recent&showReplies=0", title "Fresh Thoughts" ]
                                [ text "Fresh Thoughts"
                                , br []
                                    []
                                , span [ class "subtitle" ]
                        ...
                        , li [ class " pure-u-1-3", id "tabvoted" ]
                            [ a [ href "/Topic/View/20688?category=votes&showReplies=0", title "Hot Thoughts" ]
                                [ text "Hot Thoughts"
                                , br []
                                    []
                                , span [ class "subtitle" ]
                        ...
                        , li [ class " pure-u-1-3", id "tabreplies" ]
                            [ a [ href "/Topic/View/20688?category=replies&showReplies=0", title "Deep Thoughts" ]
                                [ text "Deep Thoughts"
                                , br []
                                    []
                                , span [ class "subtitle" ]
                                ...
                                [ div [ class "question", attribute "hs_postid" "496270", attribute "hs_replycount" "0" ]
                                    [ div [ class "q-content pure-u-1 clearfix" ]
                                        [ div [ class "q-vote clearfix" ]
                                            [ a [ class "vote-btn ", href "/Post/Vote/496270", title "thought has 0 vote. click to vote for this." ]
                                                [ span [ attribute "aria-hidden" "true" ]
                                                    [ text "0 " ]
                                                ]
                                            , a [ class "feat-btn icon-btn icon-arrow-up3", href "/Post/ToggleFeatured/496270", attribute "style" "display:block;", title "Toggle Featured" ]
                                                [ span [ class "screenreader-only" ]
                                        ...
                                        , div [ class "q-text" ]
                                            [ h3 [ class "post-description" ]
                                                [ text "Learners who may be uncomfortable with the topic                                            can choose to post anonymously, giving a voice to the voiceless. An                                            instructor will always be able to know the identify of the anonymous poster                                            through reports or by turning off their anonymous view in their own web                                            browser by using the gear icon." ]
                                            , p [ class "author" ]
                                                [ strong []
                                                    [ text "Anonymous" ]
                                                , a [ href "/Topic/ViewPost/496270" ]
                                                    [ span [ class "utctime" ]
                                                        [ text "Fri Aug 25 2017" ]
                                                    ]
                                                , text "from Hotseat"
                                                ]
                                            ]
                                        , div [ class "q-controls clearfix q-controls-admin" ]
                                            [ a [ class "fav-post fav-btn icon-star icon-btn ", href "/Post/ToggleFavorite/496270?showReplies=0", title "Toggle Favorite" ]
                                                [ span [ class "screenreader-only" ]
                                                    [ text "Toggle Favorite" ]
                                                ]
                                            , a [ class "hide-btn icon-blocked icon-btn", href "/Post/ToggleHidden/496270", title "Hide" ]
                                                [ span [ class "screenreader-only" ]
                                                    [ text "Hide" ]
                                                ]
                                            ]
                                        , a [ class "reply-btn reply-btn-show ", href "/Topic/View/20688?showReplies=496270&category=recent", title "open 0 replies" ]
